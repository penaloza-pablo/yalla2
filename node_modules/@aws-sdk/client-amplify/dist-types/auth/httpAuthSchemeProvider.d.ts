 ...
 * @internal
 */
export interface AmplifyHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<AmplifyClientResolvedConfig, HandlerExecutionContext, AmplifyHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultAmplifyHttpAuthSchemeParametersProvider: (config: AmplifyClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<AmplifyHttpAuthSchemeParameters>;
/**
 * @internal
 */
