...
export interface ECR {
    ...
    deleteSigningConfiguration(args: DeleteSigningConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteSigningConfigurationCommandOutput>;
    deleteSigningConfiguration(args: DeleteSigningConfigurationCommandInput, cb: (err: any, data?: DeleteSigningConfigurationCommandOutput) => void): void;
    deleteSigningConfiguration(args: DeleteSigningConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteSigningConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    describeImageSigningStatus(args: DescribeImageSigningStatusCommandInput, options?: __HttpHandlerOptions): Promise<DescribeImageSigningStatusCommandOutput>;
    describeImageSigningStatus(args: DescribeImageSigningStatusCommandInput, cb: (err: any, data?: DescribeImageSigningStatusCommandOutput) => void): void;
    describeImageSigningStatus(args: DescribeImageSigningStatusCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeImageSigningStatusCommandOutput) => void): void;
    /**
    ...
    getSigningConfiguration(args: GetSigningConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<GetSigningConfigurationCommandOutput>;
    getSigningConfiguration(args: GetSigningConfigurationCommandInput, cb: (err: any, data?: GetSigningConfigurationCommandOutput) => void): void;
    getSigningConfiguration(args: GetSigningConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetSigningConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    putSigningConfiguration(args: PutSigningConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<PutSigningConfigurationCommandOutput>;
    putSigningConfiguration(args: PutSigningConfigurationCommandInput, cb: (err: any, data?: PutSigningConfigurationCommandOutput) => void): void;
    putSigningConfiguration(args: PutSigningConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutSigningConfigurationCommandOutput) => void): void;
    /**
