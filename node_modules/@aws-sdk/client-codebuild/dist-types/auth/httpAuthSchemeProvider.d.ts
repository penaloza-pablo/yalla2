 ...
 * @internal
 */
export interface CodeBuildHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<CodeBuildClientResolvedConfig, HandlerExecutionContext, CodeBuildHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultCodeBuildHttpAuthSchemeParametersProvider: (config: CodeBuildClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<CodeBuildHttpAuthSchemeParameters>;
/**
 * @internal
 */
