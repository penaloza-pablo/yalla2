...
export declare class SdkProvider {
     ...
     */
    static withAwsCliCompatibleDefaults(options: SdkProviderOptions, profile?: string): Promise<SdkProvider>;
    ...
    constructor(defaultCredentialProvider: SDKv3CompatibleCredentialProvider, defaultRegion: string | undefined, options: SdkProviderOptions);
    /**
