...
class Formatter {
    ...
    print(fmt, ...args) {
        this.stream.write(chalk.reset((0, util_1.format)(fmt, ...args)) + '\n');
    }
    warning(fmt, ...args) {
