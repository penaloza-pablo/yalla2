...
export declare function emptyDatabase(): Database<{
    ...
    eventTypeDefinition: import("@cdklabs/tskb").EntityCollection<EventTypeDefinition, {}>;
    ...
    event: import("@cdklabs/tskb").EntityCollection<Event, {
        name: import("@cdklabs/tskb").EntityIndex<Event, string>;
    }>;
}, {
    ...
    resourceHasEvent: import("@cdklabs/tskb").RelationshipCollection<ResourceHasEvent>;
    eventUsesType: import("@cdklabs/tskb").RelationshipCollection<EventUsesType>;
}>;
