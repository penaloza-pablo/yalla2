...
export type GenericPropertyType<T extends Entity> = PrimitiveType | GenericDefinitionReference<T> | BuiltinTagType | ArrayType<GenericPropertyType<T>> | MapType<GenericPropertyType<T>> | TypeUnion<GenericPropertyType<T>>;
