...
export declare const ServerSideEncryptionIn: {
...
export declare const ObjectStorageClassIn: {
...
export interface DescribeRepositoriesCommandOutput extends DescribeRepositoriesResponse, MetadataBearer {
}
...
export interface GetAuthorizationTokenCommandOutput extends GetAuthorizationTokenResponse, MetadataBearer {
}
